...
sout.flowrate = 0.56;%0.56; % Flowrate out of pipe, m^3/s
...
sout.profile='argoclim_jul.mat';%File for background profile. Currently assumes it is an ARGO single profile 
...
sout.climatology = 1;%Tells the code if it should be using a climatology
sout.surfacetemp = 1;
sout.U_para = 1; %First ambient velocity parameter
sout.U_parb = 1; %Second ambient velocity parameter
sout.Ua = @(z,para,parb)  0.1; %Ambient Velocity, function of two parameters
